...
if (!objectiveComplete && obj_input.drawPauseMenu = false) {
	...
	draw_text(obj_player_stats.guiWidth-615, obj_player_stats.guiHeight-150 - thk, string_hash_to_newline("OBJECTIVE: Interact with the book on the counter#with X."));*/
	draw_set_color(c2);
	draw_text(obj_player_stats.guiWidth-615, obj_player_stats.guiHeight-155, string_hash_to_newline("OBJECTIVE: Interact with the book on the counter#downstairs with the X key."));
	//draw_sprite(spr_scroll, image_index, guiWidth-9, guiHeight-32);
}
if (objectiveComplete && !objective1Complete && obj_input.drawPauseMenu = false) {
	...
	draw_text(obj_player_stats.guiWidth-615 + thk, obj_player_stats.guiHeight-150, string_hash_to_newline("OBJECTIVE: Interact with the sign to the east#of your house."));*/
	draw_set_color(c2);
	draw_text(obj_player_stats.guiWidth-615, obj_player_stats.guiHeight-155, string_hash_to_newline("OBJECTIVE: Interact with the sign to the east#of your house."));
}
if (objective1Complete && !objective2Complete && obj_input.drawPauseMenu = false) {
	draw_text(obj_player_stats.guiWidth-615, obj_player_stats.guiHeight-155, string_hash_to_newline("OBJECTIVE: Either explore the Sakura Forest maze#for treasure, or enter the Shadow Temple to beat#the Ketchup Boss and obtain the Shadow Rune."));
}
}
